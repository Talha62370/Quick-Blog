  ...
  <div className='flex-1 p-4 md:p-10 bg-blue-50/50'>
    ...
    <div className='flex flex-wrap gap-4'>
      ...
      <div className='flex items-center gap-4 bg-white p-4 min-w-58 rounded
        shadow cursor-pointer hover:sclae-105 transition-all'>
        <img src={assets.dashboard_icon_1} alt="" />
        <div>
          <p className='text-xl font-semiold text-gray-600'>
    ...
    <div>
     <div className='flex items-center gap-3 m-4 mt-10 text-gray-600'>
      ...
      <div className='relative max-w-4xl overflow-x-auto shadow rounded-ld
